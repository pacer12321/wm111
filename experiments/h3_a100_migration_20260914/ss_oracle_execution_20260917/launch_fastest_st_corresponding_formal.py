...
EXPERIMENT = ROOT / "fastest_st_corresponding_formal_20260917_v1"
TRANSFORMER = (
    CANDIDATE
...
os.environ.update(
    ...
    ZHONGHAO_H3_DROP_SOURCE_TO_TARGET="0",
    ZHONGHAO_H3_SOURCE_TO_TARGET_CORRESPONDING="1",
    ZHONGHAO_H3_EXPERIMENT_LABEL=(
        "Formal fastest B+VDN+interleaved latent token-skip with fixed-shape "
        "corresponding-frame S_i-to-T_i attention; S-S remains dense and all "
        "T-side routes are unchanged"
    ),
)
