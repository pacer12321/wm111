...
class MiniMaxH3Pipeline(
    ...
    def __init__(
        ...
        *,
        ...
        # Compatibility marker for the isolated prepared-offload hook.  A/base
        # deliberately has no Stage-B/OpenVDN checkpoint.
        self._openvdn_checkpoint = None
    ...
    def _load_weights_impl(
        ...
        *,
        ...
        # Keep the original Ref2VA loading semantics.  The explicit helper is
        # the hook point required by the already-validated prepared offloader.
        del phase_timings
        prefix = "transformer."
