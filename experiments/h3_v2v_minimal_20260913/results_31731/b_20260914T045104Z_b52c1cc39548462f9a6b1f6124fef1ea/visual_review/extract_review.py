"""Read-only input decoding for the new shirt-color B trial; local CPU QA.
...
SPECS = {
    ...
    'B_color': (RUN / 'b_50step.mp4', '3fbab6d81d65bb40a0d86e889f7348eb37d2b3107d02cc5e87ea45875f5fd950', 4897397, (1344, 768), True),
}
...
def contact(indices, frames):
    ...
    for col, title in enumerate(('Source | unchanged original', 'B VDN | only man shirt -> red')):
...
def main():
    if RUN.name != 'b_20260914T045104Z_b52c1cc39548462f9a6b1f6124fef1ea':
    ...
    contacts = ['source_B_color_contact.jpg'] + [f'source_B_color_part_{n}.jpg' for n in (1, 2, 3)]
