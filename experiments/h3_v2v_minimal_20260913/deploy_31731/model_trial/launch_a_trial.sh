...
case "${H3_TRIAL_SAMPLE}" in
  ...
  *) echo 'Only frozen lake_snow/reverse sample profiles are allowed' >&2; exit 2 ;;
esac
task_prefix="/cache/zhonghao/h3/model_trial/${H3_TRIAL_GROUP}/${H3_TRIAL_SAMPLE}/A/runs/a_"
