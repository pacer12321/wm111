...
class MiniMaxH3Attention(nn.Module):
    def __init__(
        ...
        *,
        ...
        # of post-QK-norm, post-RoPE Q/K plus V without changing the dense
        # attention calculation or its backend.  V is required to measure the
        # actual attention-core output error of Oracle T-to-S frame masks,
        # rather than treating retained softmax mass as a quality proxy.
