...
CANDIDATE = RUN / "candidate_B_skip_ts_attn_capture"
LOADER = RUN / "loader"
EXPERIMENT = RUN / "results/B_DMD8_latent_ts_attn_capture_all8"
...
os.environ.update(
    ...
    ZHONGHAO_H3_EXPERIMENT_LABEL=(
        "DMD8 latent-skip attention capture: target queries for T-S/T-T, "
        "layers 8/24/41, all 8 forwards"
    ),
)
