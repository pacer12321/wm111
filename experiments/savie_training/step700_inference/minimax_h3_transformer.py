...
class MiniMaxH3DiTModel(nn.Module):
    ...
    def forward(self, **kwargs: Any) -> tuple[torch.Tensor, torch.Tensor]:
        ...
        if self.arch.openvdn_enabled:
            ...
            if self._source_hybrid_enabled or os.environ.get("SAVIE_STEP700_CHECKPOINT"):
...
if os.environ.get("SAVIE_STEP700_CHECKPOINT"):
    import sys as _savie_sys
    from savie_overlay import install as _install_savie_overlay
    _install_savie_overlay(_savie_sys.modules[__name__])
