...
A_CODE = Path('/cache/zhonghao/h3/color_trial_v1/a')
...
def selected_profile(group, sample_id=DEFAULT_SAMPLE):
    ...
    return replace(tiny, output_root=ROOT / 'color_trial_v1/results' / group / sample.sample_id / 'B',
