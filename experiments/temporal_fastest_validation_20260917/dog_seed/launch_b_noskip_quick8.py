"""Eight-schedule-point go/no-go preview for strict temporal reordering."""
...
os.environ.update(
    ZHONGHAO_H3_SPOTEDIT_EXPERIMENT=f"{ROOT}/temporal_dog_B_noskip_quick8_20260917_v1",
    ...
    ZHONGHAO_H3_REQUEST_STEPS="8",
    ZHONGHAO_H3_PRECHECK_STEPS="0",
    ZHONGHAO_H3_EXPERIMENT_LABEL=(
        "Quick8 strict temporal-reordering control: B attention, no token skip"
    ),
)
