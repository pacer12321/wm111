"""Read-only input decoding for the new shirt-color D trial; local CPU QA.
...
RUN = HERE.parent
ROOT = RUN.parent
OLD = Path('C:/Users/DZH/OneDrive/Documents/ChatGPT/wm111/experiments/h3_v2v_minimal_20260913/results_31731/a_20260913T153514Z_91c6c0f98ba84c7c828202d5934176cd')
...
SPECS = {
    ...
    'D_color': (RUN / 'output/d_50step.mp4', '5cb4b4e3f215e6f3cb0403a8a993e4977d40f17eaccbda876a2fba8d7bf4363b', 4448282, (1344, 768), True),
}
...
def contact(indices, frames):
    ...
    for col, title in enumerate(('Source | unchanged original', 'D S-hybrid+same-frame | only man shirt -> red')):
...
def main():
    if RUN.name != 'd_20260914T072058Z_7de1704b57104dc5adc17f78211f6395':
    ...
    contacts = ['source_D_color_contact.jpg'] + [f'source_D_color_part_{n}.jpg' for n in (1, 2, 3)]
