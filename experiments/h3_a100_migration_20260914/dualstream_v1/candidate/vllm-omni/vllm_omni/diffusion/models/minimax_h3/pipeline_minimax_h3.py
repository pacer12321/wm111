...
from .dual_stream_adapter import begin_request as begin_d_request
...
class MiniMaxH3Pipeline(
    ...
    def diffuse(
        ...
        *,
        ...
        # DenoiseBranch.forward_kwargs preserves static_kwargs each step.
        branch.static_kwargs["c_source_layout_metadata"] = c_source_metadata
        d_request_index = begin_d_request()
        logger.info("D source layout metadata request=%s: %s", d_request_index, c_source_metadata)
