...
EXPERIMENT = ROOT / "ss_cached_topk_timesteps_redshirt_20260917_v1"
...
os.environ.update(
    ...
    ZHONGHAO_H3_FIXED_SELECTOR_PAYLOAD=str(
        ROOT / "spotedit_selector_capture_20260915_v1/latent_analysis_v2/fixed_selector_payload.pt"
    ),
    ...
    ZHONGHAO_H3_SS_ORACLE_CAPTURE_STEPS="4,25,45",
    ZHONGHAO_H3_SS_ORACLE_CAPTURE_LAYERS="8,24,41",
    ZHONGHAO_H3_EXPERIMENT_LABEL=(
        "Fastest B+VDN+interleaved latent token-skip baseline; computation unchanged; "
        "capture S queries and full K/V at steps 4,25,45 for exact first-step cached "
        "remote-frame Top-K stability. S-to-T remains dense."
    ),
)
