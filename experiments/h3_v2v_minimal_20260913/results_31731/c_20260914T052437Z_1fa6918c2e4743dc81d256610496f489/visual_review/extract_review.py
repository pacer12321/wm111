"""Read-only input decoding for the new shirt-color C trial; local CPU QA.
...
SPECS = {
    ...
    'C_color': (RUN / 'c_50step.mp4', 'f17aedffb0f1492266e81e6d866a9fb887ac653706291d7f6fb3c5dbb313b593', 4484668, (1344, 768), True),
}
...
def contact(indices, frames):
    ...
    for col, title in enumerate(('Source | unchanged original', 'C VDN+same-frame | only man shirt -> red')):
...
def main():
    if RUN.name != 'c_20260914T052437Z_1fa6918c2e4743dc81d256610496f489':
    ...
    contacts = ['source_C_color_contact.jpg'] + [f'source_C_color_part_{n}.jpg' for n in (1, 2, 3)]
